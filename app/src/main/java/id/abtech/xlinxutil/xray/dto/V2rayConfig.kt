package id.abtech.xlinxutil.xray.dto
...
data class V2rayConfig(
    ...
    data class OutboundBean(val tag: String,
        ...
        fun getServerAddress(): String? {
            ...
            } else if (protocol.equals(EConfigType.SHADOWSOCKS.name.toLowerCase()) || protocol.equals(
                    EConfigType.SOCKS.name.toLowerCase())) {
