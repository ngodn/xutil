...
import id.abtech.xlinxutil.xray.extension.responseLength
import id.abtech.xlinxutil.xray.extension.toast
import id.abtech.xlinxutil.xray.extension.v2RayApplication
import id.abtech.xlinxutil.xray.service.V2RayServiceManager
...
object Utils {
    ...
    fun getRemoteDnsServers(defaultDPreference: DPreference): ArrayList<String> {
        val remoteDns = defaultDPreference.getPrefString(V2RayVpnService.PREF_REMOTE_DNS, AppConfig.DNS_AGENT)
    ...
    fun getDomesticDnsServers(defaultDPreference: DPreference): ArrayList<String> {
        val domesticDns = defaultDPreference.getPrefString(V2RayVpnService.PREF_DOMESTIC_DNS, AppConfig.DNS_DIRECT)
        val ret = ArrayList<String>()
