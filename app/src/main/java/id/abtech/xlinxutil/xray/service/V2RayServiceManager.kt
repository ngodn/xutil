...
import id.abtech.xlinxutil.AppConfig.TAG_DIRECT
import id.abtech.xlinxutil.R
import id.abtech.xlinxutil.xray.extension.defaultDPreference
import id.abtech.xlinxutil.xray.extension.toSpeedString
import id.abtech.xlinxutil.xray.extension.toast
import id.abtech.xlinxutil.xray.extension.v2RayApplication
//import id.abtech.xlinxutil.ui.MainActivity
...
import go.Seq
import id.abtech.xlinxutil.XlinxInstallerActivity
...
object V2RayServiceManager {
    ...
    fun startV2Ray(context: Context) {
        if (context.v2RayApplication.defaultDPreference.getPrefBoolean(V2RayVpnService.PREF_PROXY_SHARING, false)) {
    ...
    fun startV2rayPoint() {
        ...
        if (!v2rayPoint.isRunning) {
            ...
            v2rayPoint.enableLocalDNS = service.defaultDPreference.getPrefBoolean(V2RayVpnService.PREF_LOCAL_DNS_ENABLED, false)
            v2rayPoint.forwardIpv6 = service.defaultDPreference.getPrefBoolean(V2RayVpnService.PREF_FORWARD_IPV6, false)
    ...
    private fun showNotification() {
        val service = serviceControl?.get()?.getService() ?: return
        val startMainIntent = Intent(service, XlinxInstallerActivity::class.java)
    ...
    fun startSpeedNotification() {
        ...
        if (mSubscription == null &&
                ...
                service.defaultDPreference.getPrefBoolean(V2RayVpnService.PREF_SPEED_ENABLED, false)) {
