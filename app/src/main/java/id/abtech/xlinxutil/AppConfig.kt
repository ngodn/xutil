 ...
 */
object AppConfig {
    const val ANG_PACKAGE = "id.abtech.xlinxutil"
    ...
    const val BROADCAST_ACTION_SERVICE = "id.abtech.xlinxutil.action.service"
    const val BROADCAST_ACTION_ACTIVITY = "id.abtech.xlinxutil.action.activity"
    const val BROADCAST_ACTION_WIDGET_CLICK = "id.abtech.xlinxutil.action.widget.click"
